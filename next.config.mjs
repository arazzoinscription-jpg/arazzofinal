...
const nextConfig = {
  ...
  async headers() {
    ...
    const csp = [
      ...
      "frame-src 'self' https://iframe.mediadelivery.net https://*.b-cdn.net https://www.youtube.com https://player.vimeo.com https://*.trycloudflare.com https://www.facebook.com https://web.facebook.com https://*.facebook.com",
