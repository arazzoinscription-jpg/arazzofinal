...
import { setCourseSubscription } from "../actions";
import { batchSizes } from "@/lib/subscription-plan";

/**
 * Toggle « mode abonnement » d'une formation (paiement par tranches + ouverture
 * progressive des chapitres). Réservé à l'admin. Quand activé, l'admin saisit la
