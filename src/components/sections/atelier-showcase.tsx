      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <Reveal animation="left" className="relative">
            ...
            <div className="relative rounded-[2rem] overflow-hidden border-[6px] border-white shadow-2xl">
              <img src="/images/mannequin-couture.jpg" alt="Mannequin de bois à la machine à coudre"
          ...
          <div>
            ...
            <div className="space-y-4 mb-9">
              {FEATURES.map(({ Icon, title, desc }, i) => (
                <Reveal key={title} animation="up" delay={i * 90} className="flex items-start gap-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 mt-20">
          {GALLERY.map((g, i) => (
            <Reveal key={g.label} animation="up" delay={i * 110}
