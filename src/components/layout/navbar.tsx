          ...
          <motion.div variants={itemV} className="hidden md:flex items-center gap-3">
            ...
            {user ? (
              ...
              <>
                ...
                <MotionLink href="/register" whileHover={{ scale: 1.04, y: -1 }} whileTap={{ scale: 0.96 }} transition={{ type: "spring", stiffness: 300 }}
                  className="bg-orange-DEFAULT hover:bg-orange-600 text-white px-5 py-2.5 rounded-xl font-semibold text-sm shadow-md transition-colors">
                  {t.register}
                </MotionLink>
              </>
              ...
              <div className="flex flex-col p-3">
                ...
                {user ? (
                  ...
                  <motion.div variants={mLink} className="flex gap-3 mt-1">
                    ...
                    <Link href="/register" onClick={() => setMenuOpen(false)} className="flex-1 text-center bg-orange-DEFAULT text-white py-2.5 rounded-xl font-semibold text-sm">{t.register}</Link>
                  </motion.div>
                )}
              </div>
            </motion.div>
